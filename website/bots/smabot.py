...
def smacalculation(candlecloses, backtesting):

    closes_20_old = candlecloses[-21:]
    closes_20_old.pop()
    closes_20_new = candlecloses[-20:]
    closes_100 = candlecloses
    sma20 = [get_sma(closes_20_old, 20), get_sma(closes_20_new, 20)]
    sma100 = get_sma(closes_100, 100)

    if sma100 > 0: 
        if sma20[1] > sma100 and sma20[0] < sma100:
        ...
        elif sma20[1] < sma100 and sma20[0] > sma100:
            from .basebot import in_position
            if in_position:
